...
HELPER_UTILS=(base-devel bluez-utils cronie curl eza fastfetch figlet flatpak fzf gamemode git lib32-gamemode openssh pacman-contrib plymouth reflector rsync ufw zoxide)  # Helper utilities to install
