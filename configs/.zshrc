...
# SSH Connections
# -----------------------------------------------------------------------------
alias nas='ssh nas@gandromidas.ddnsfree.com'
alias pi='ssh pi@gandro.ddnsfree.com'
alias kristina='ssh kristina@192.168.1.147'

# -----------------------------------------------------------------------------
# Windows
# -----------------------------------------------------------------------------
alias windows='sudo bootctl set-oneshot auto-windows && systemctl reboot'           # Reboot to Windows
