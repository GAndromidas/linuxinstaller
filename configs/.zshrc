...
alias clean='sudo pacman -Sc --noconfirm && yay -Sc --noconfirm && sudo flatpak uninstall --unused && sudo pacman -Rns $(pacman -Qtdq) 2>/dev/null'  # Clean package cache and orphans
