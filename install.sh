...
load_program_lists() {
    pacman_programs=($(cat /home/"$USER"/archinstaller/pacman_programs.txt))
    yay_programs=($(cat /home/"$USER"/archinstaller/yay_programs.txt))
    essential_programs=($(cat /home/"$USER"/archinstaller/essential_programs.txt))
    kde_programs=($(cat /home/"$USER"/archinstaller/kde_programs.txt))
}
